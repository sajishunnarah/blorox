import { SceneRenderer } from "./engine3d.js";
import { NightfallIslandGame } from "./nightfall-island.js";
...
(() => {
  ...
  function mountIsland() {
    const mount = document.querySelector("#gameMount");
    const island = new NightfallIslandGame({ mount, keys: state.keys, playTone, escapeHtml });
    island.start();
    state.cleanup = () => island.dispose();
  }
